...
# 输出提取结果
# print("Warnings (Element ID):")
# print(warpage_angle_np[:,0])
# print("Warnings int (Element ID):")
# print(warpage_angle_int)

# print("Shell Element Failures (Element ID):")
# print(shell_failures_np[:,0])
# print("Shell Element Failures int (Element ID):")
# print(shell_failures_int)

def process_and_count_Failure_Elements(file1_path, element_list, Part_FailureElements):
    # 读取文件的数据（格式：pid, eid, ...）
    # Part_FailureElements = {}
